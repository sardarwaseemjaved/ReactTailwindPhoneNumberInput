...
import { memoize, reduce, startsWith, debounce } from 'lodash'
    ...
    render() {
        ...
        return (
            <div
                ...
                bg-white appearance-none border rounded-full w-full mt-[13px] text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-[55px] pl-[10px]`}
                ...
                <div className='flex'>
                    <div
                        ...
                        // className={"appearance-none border rounded-[30px] py-2 pl-4 pr-16 text-gray-700  focus:outline-none focus:shadow-outline md:w-[70px] w-[70px] cursor-pointer " + (this.props.flagClassName || '')}
                    ...
                    <input
                        className={"appearance-none border rounded-[30px]  lg:py-2 md:py-2 py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full md:h-[54px] h-auto ml-[10px] bg-transparent" + (this.props.inputClassName || '')}
